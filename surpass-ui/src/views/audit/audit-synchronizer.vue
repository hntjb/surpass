<template>
  <div class="app-container">
    ...
    <el-table ref='multipleTable'
      ...
      <el-table-column prop="syncId" :label="$t('jbx.history.synchronizerSyncid')" align="center" min-width="50"/>
      <el-table-column prop="syncName" :label="$t('jbx.history.synchronizerSyncname')" align="center" min-width="120"/>
      <el-table-column prop="objectId" :label="$t('jbx.history.synchronizerObjectid')" align="center" min-width="120"/>
      <el-table-column prop="objectType" :label="$t('jbx.history.synchronizerObjecttype')" align="center" min-width="120"/>
      <el-table-column prop="objectName" :label="$t('jbx.history.synchronizerObjectname')" align="center" min-width="120"/>
      <el-table-column prop="syncTime" :label="$t('jbx.history.synchronizerSynctime')" align="center" min-width="120"/>
      <el-table-column prop="result" :label="$t('jbx.history.systemlogsMessageresult')" align="center" min-width="120"/>
    </el-table>
...
import {synchronizerHistory} from "@/api/audit/audit";
