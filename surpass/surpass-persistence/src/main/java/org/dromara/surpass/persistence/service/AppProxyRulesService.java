...
public interface AppProxyRulesService extends IJpaService<AppProxyRules> {
    Message<String> create(AppProxyRulesChangeDto dto);

    Message<String> updateProxyRules(AppProxyRulesChangeDto dto);
